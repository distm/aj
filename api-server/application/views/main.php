...
<ul>
    ...
    <li style="padding-bottom:15px">
        ...
        Menampilkan grafik statistik tentang data Perusahaan dan Seeker yang terdaftar.
    </li>
    
    <li style="padding-bottom:15px">
        <strong>Blog</strong><br />
        Berfungsi untuk memanage blog di job4career.com. Menampilkan daftar artikel yang telah terpublish,
        menghapus dan menambahkan artikel.
    </li>
</ul>